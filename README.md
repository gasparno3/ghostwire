...
resolve_ip=""              # pre-resolve domain to IP; accepts single IP, comma-separated list, or TOML array
resolve_ip_mode="least_ping"   # IP selection mode when multiple IPs given: "least_ping" (default) or "round_robin"
resolve_ip_latency_interval=60 # seconds between latency re-checks in least_ping mode
