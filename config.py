...
class ServerConfig:
    def __init__(self,config_path):
        ...
        self.http_request_min_upload_ms=config["server"].get("http_request_min_upload_ms",50)
        self.http_request_min_download_ms=config["server"].get("http_request_min_download_ms",100)
        self.http_request_max_upload_bytes=config["server"].get("http_request_max_upload_bytes",262144)
        self.http_request_max_download_bytes=config["server"].get("http_request_max_download_bytes",262144)
